...
class UR(RobotBase):
    def __init_robot__(self):
        ...
        # self.id = p.loadURDF('./urdf/ur.urdf', self.base_pos, self.base_ori,
        #                      useFixedBase=True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
        
        self.id = p.loadURDF('./urdf/ur5.urdf',self.base_pos, self.base_ori, useFixedBase = True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
